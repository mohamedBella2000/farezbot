module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'IG : faaaarr__'
      if (!('sk_author' in setting)) setting.sk_author = 'By @ꭙࣼ.farzོ'
      ...
      global.db.setting = {
         ...
         prefix: ['.', '#', '!', '/'],
         onlyprefix: '+',
         owners: ['6285692949920'],
         cover: 'https://telegra.ph/file/3b7b94c58ed607b5a6f78.jpg',
         header: 'JUST FOR FUN',
